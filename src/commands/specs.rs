...
const DESIGN_PROMPT: &str = include_str!("../prompts/specs/DESIGN.md");
const UPDATE_PROMPT: &str = include_str!("../prompts/specs/UPDATE.md");
...
pub fn handle(args: &SpecsArgs) -> Result<()> {
    if args.list_sounds {
